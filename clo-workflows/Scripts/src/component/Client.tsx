...
export class Anonymous extends  React.Component<any, any> {
  ...
  return (
    ...
    <Dropdown
      ...
      options = {Array.from(projectTypes).map(field=>({text:field, value: field, key: field}))}
    ...
    
{
  this.clientStore.newProjectState.selectedType &&
        <FormControlGroup
          ...
          formControls={this.clientStore.getDataService().getProjectFormControls().get("Synch")}
          validation={{}} 
