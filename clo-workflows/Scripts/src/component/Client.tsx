        ...
        <Pivot linkSize={PivotLinkSize.large} linkFormat={PivotLinkFormat.tabs}>
          <PivotItem linkText="New Request">
            ...
            <PrimaryButton              
              ...
              primary
              onClick={()=> clientStore.updateMember("startNewRequest")}
               />
               : 
               <PrimaryButton              
               text="Cancel Request"
               primary
               onClick={()=> clientStore.clear()}
                />
            }
