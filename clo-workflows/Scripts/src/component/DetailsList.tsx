...
> {
    ...
    if (_items.length === 0) {
      for (let i = 0; i < 200; i++) {
        _items.push({
          ...
          process: i + 1,
          processDescription:
            "Lorem ipsum dolor, sit amet consectetur adipisicing elit. Aperiam vel quisquam ipsam iure odio sint, natus unde velit tempora nulla ad mollitia!",
  ...
  private _getSelectionDetails(): string {
    ...
    switch (selectionCount) {
      ...
      case 1:
        return "1 item selected: " + (this._selection.getSelection()[0] as any).project
      default:
  ...
  private _onChanged(text: any): void {
    this.setState({
      items: text ? _items.filter(i => i.project.toLowerCase().indexOf(text) > -1) : _items,
    })
  }
