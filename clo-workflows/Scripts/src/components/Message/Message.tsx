...
/**
 * the custom message type that maps to MessageBarTypes is repetitive,
 * it mirrors office-ui-fabric/MessageBarType however,
 * if any fabric moduels are imported into stores,
 * it breaks tests.
 * This means I have to make my own mapping logic and use that instead
 */
