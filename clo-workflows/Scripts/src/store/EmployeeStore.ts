...
export class EmployeeStore {
    ...
    async submitSelectedProcess(): Promise<void> {
        ...
        try {
            ...
            updatedProcess = {...updatedProcess, ...{
                ...
                [currentStep.submissionDateFieldName]: this.utils.getFormattedDate(),
    ...
    @action async submitSelectedProcessToNextStep() {
        ...
        const nextStepProcess = {...curProcess, ...{
            ...
            [nextStep.submissionDateFieldName]: this.utils.getFormattedDate()
        }}
    ...
    @computed get canSubmitSelectedProcess(): boolean {
        return !this.asyncPendingLockout && this.utils.isObjectEmpty(this.selectedProcessValidation)
    }
